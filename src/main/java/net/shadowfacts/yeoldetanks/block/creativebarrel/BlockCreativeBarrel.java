 ...
 * @author shadowfacts
 */
public class BlockCreativeBarrel extends Block implements ITileEntityProvider, AchievementProvider {

	public BlockCreativeBarrel() {
		super(Material.rock);
		setBlockName("yot.creativeBarrel");
	...
	public int getRenderType() {
		return CreativeBarrelISBRH.RENDER_ID;
	}
	...
	public boolean isSideSolid(IBlockAccess world, int x, int y, int z, ForgeDirection side) {
		if (side == ForgeDirection.DOWN) {
			...
			TileEntity te = world.getTileEntity(x, y, z);
			if (te instanceof TileEntityCreativeBarrel) {
				return ((TileEntityCreativeBarrel)te).lid;
			}
		}
		return false;
	}
