# Playground
- A repo containing all the base files/configurations needed to quickly start a Minecraft mod.
- A playground, each branch represents 1 sandbox in the playground and is where I play around with ideas and things
